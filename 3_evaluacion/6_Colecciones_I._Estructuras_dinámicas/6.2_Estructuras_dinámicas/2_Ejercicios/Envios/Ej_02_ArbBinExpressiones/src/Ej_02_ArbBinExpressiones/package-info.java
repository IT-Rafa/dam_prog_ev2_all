 ...
 * <h3>Árbol binario que almacena expresión aritmética</h3>
 ...
 * expresión aritmética en notación infija.
 * <pre>
((9 - (5 + 2 ))x 3)
 * </pre>
 ...
 * 
 * SE PIDE:<p>
 * Que envies la clase Arbol y NodoArbol incorporando el método imprimir 
 * a la clase Arbol. <p>
 * <pre>
((9 - (5 + 2 ))x 3)
 * </pre>
