...
public class Ejercicio_U7_B4B_E1 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Precio Desglosado " + tuberias.getNombre() + ": " + tuberias.getPrecioDesglosado());

        System.out.println("Precio Desglosado " + casa.getNombre() + ": " + casa.getPrecioDesglosado());
    }
}
